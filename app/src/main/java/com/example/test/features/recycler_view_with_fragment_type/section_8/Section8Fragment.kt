package com.example.test.features.recycler_view_with_fragment_type.section_8
...
import com.example.test.databinding.ItemFragment2Binding
...
class Section8Fragment : Fragment() {
    private var _binding: ItemFragment2Binding? = null
    private val binding get() = _binding!!
    private val viewModel: Section1ViewModel by viewModels()

    private lateinit var mLayoutManager: LinearLayoutManager
    private val mAdapter by lazy {
        PostListAdapter(PostListAdapter.VIEW_ITEM_POST_V2_TYPE)
    }
    ...
    override fun onCreateView(
        ...
        _binding = ItemFragment2Binding.inflate(inflater, container, false)
        return binding.root
    }
