package com.example.test.features.recycler_view_with_fragment_type.section_10
...
import com.example.test.databinding.ItemFragment4Binding
...
class Section10Fragment : Fragment() {
    private var _binding: ItemFragment4Binding? = null
    private val binding get() = _binding!!
    private val viewModel: Section1ViewModel by viewModels()

    private lateinit var mLayoutManager: LinearLayoutManager
    private val mAdapter by lazy {
        PostListAdapter(PostListAdapter.VIEW_ITEM_POST_V4_TYPE)
    }
    ...
    override fun onCreateView(
        ...
        _binding = ItemFragment4Binding.inflate(inflater, container, false)
        return binding.root
    }
