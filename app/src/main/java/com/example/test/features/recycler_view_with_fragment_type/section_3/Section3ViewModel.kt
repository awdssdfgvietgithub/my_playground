package com.example.test.features.recycler_view_with_fragment_type.section_3
...
class Section3ViewModel : ViewModel() {
    ...
    fun fetchAllPostList() = viewModelScope.launch(Dispatchers.IO) {
        ...
        val response = ApiClient.apiService.getPosts(20, 3)
