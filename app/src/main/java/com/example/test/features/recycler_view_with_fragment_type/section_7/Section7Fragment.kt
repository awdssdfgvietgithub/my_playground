package com.example.test.features.recycler_view_with_fragment_type.section_7
...
import com.example.test.databinding.ItemFragment1Binding
...
class Section7Fragment : Fragment() {
    private var _binding: ItemFragment1Binding? = null
    private val binding get() = _binding!!
    private val viewModel: Section1ViewModel by viewModels()

    private lateinit var mLayoutManager: LinearLayoutManager
    private val mAdapter by lazy {
        PostListAdapter(PostListAdapter.VIEW_ITEM_POST_V1_TYPE)
    }
    ...
    override fun onCreateView(
        ...
        _binding = ItemFragment1Binding.inflate(inflater, container, false)
        return binding.root
    }
